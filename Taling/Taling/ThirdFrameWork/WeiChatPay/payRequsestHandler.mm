...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demoWithOrderDict:(PayOrderInfoModel*)orderInfo
{

    //订单标题，展示给用户
    NSString *order_name    = orderInfo.productName;
    //订单金额,单位（分）*100
    NSString *order_price   = [NSString stringWithFormat:@"%.0f",[orderInfo.amount floatValue] *100 ];
    
    
   NSString *orderno   = [NSString stringWithFormat:@"%@",orderInfo.out_trade_no];
