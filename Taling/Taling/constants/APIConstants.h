...
/*
 ...
 1 buyresumesCountSum 2 saleresumesCountSum (resumesCountSum)   3 reservNum  4 money    5 couponNum  6 appraiseNum
 */
 ...
 *
 */
//response :key:(id ,couponPrice ,startTime,endTime,status,userId), (格式:data{ {id:xx,couponPrice:xx，……,userId:xx}           })
